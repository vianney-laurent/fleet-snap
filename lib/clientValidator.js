...
export function useFormValidation() {
  // Import React hooks seulement côté client
  if (typeof window === 'undefined') {
    return {
      validationResults: {},
      isValidating: false,
      validateField: () => Promise.resolve({ valid: true, errors: [], warnings: [] }),
      validateForm: () => Promise.resolve({ valid: true, errors: [], warnings: [] }),
      clearValidation: () => {}
    };
  }
