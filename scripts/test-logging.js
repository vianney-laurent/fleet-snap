...
/**
 * Script de test pour le système de logging FleetSnap
...
async function testLogging() {
  ...
  console.log('📈 Vérifiez vos logs dans Axiom avec le dataset:', process.env.NEXT_PUBLIC_AXIOM_DATASET);
  console.log('🔍 Filtrez par testMode:true pour voir uniquement les logs de test');
}
